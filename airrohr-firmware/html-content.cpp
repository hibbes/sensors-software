/**
 * Definitions for PROGMEM constants (declared in html-content.h).
 * Issue #18 Phase B — split for multi-TU access.
 */
#include <Arduino.h>
#include <pgmspace.h>
...
const size_t WEB_PAGE_STATIC_CSS_LEN = sizeof(WEB_PAGE_STATIC_CSS) - 1;
